...
IL_0009:
	{
		...
		OculusSettings_t0584FB71432B697479FD0BFC5B68C195F17CD321* L_1;
		L_1 = OculusLoader_GetSettings_m2FA61767F36A8CFB03124EB295A79C7A7F0A863B_inline(__this, NULL);
		V_0 = L_1;
		// if (settings != null)
		OculusSettings_t0584FB71432B697479FD0BFC5B68C195F17CD321* L_2 = V_0;
	...
	}
	{
		...
		OculusSettings_t0584FB71432B697479FD0BFC5B68C195F17CD321* L_4 = V_0;
		NullCheck(L_4);
		bool L_5 = L_4->___SharedDepthBuffer_6;
		G_B4_0 = (&V_1);
		if (L_5)
		{
			G_B5_0 = (&V_1);
...
IL_0043:
	{
		...
		NullCheck(L_8);
		uint16_t L_9;
		L_9 = OculusSettings_GetStereoRenderingMode_mE9C6ABC56B9EDEB3BE5599B091BB6699429BB6BD(L_8, NULL);
		(&V_1)->___stereoRenderingMode_2 = L_9;
		// userDefinedSettings.colorSpace = (ushort)((QualitySettings.activeColorSpace == ColorSpace.Linear) ? 1 : 0);
		int32_t L_10;
		L_10 = QualitySettings_get_activeColorSpace_m7BD95E037EC83AD498617F7906B41932CE33288B(NULL);
		G_B10_0 = (&V_1);
...
IL_0064:
	{
		...
		OculusSettings_t0584FB71432B697479FD0BFC5B68C195F17CD321* L_11 = V_0;
		NullCheck(L_11);
		bool L_12 = L_11->___LowOverheadMode_9;
		G_B13_0 = (&V_1);
		if (L_12)
		{
			G_B14_0 = (&V_1);
...
IL_0078:
	{
		...
		NullCheck(L_13);
		bool L_14 = L_13->___ProtectedContext_10;
		G_B16_0 = (&V_1);
		if (L_14)
		{
			G_B17_0 = (&V_1);
...
IL_008c:
	{
		...
		NullCheck(L_15);
		bool L_16 = L_15->___FocusAware_11;
		G_B19_0 = (&V_1);
		if (L_16)
		{
			G_B20_0 = (&V_1);
...
IL_00a0:
	{
		...
		NullCheck(L_17);
		bool L_18 = L_17->___OptimizeBufferDiscards_12;
		G_B22_0 = (&V_1);
		if (L_18)
		{
			G_B23_0 = (&V_1);
...
IL_00b4:
	{
		...
		NullCheck(L_19);
		bool L_20 = L_19->___PhaseSync_13;
		G_B25_0 = (&V_1);
		if (L_20)
		{
			G_B26_0 = (&V_1);
...
IL_00c8:
	{
		...
		NullCheck(L_21);
		bool L_22 = L_21->___SubsampledLayout_14;
		G_B28_0 = (&V_1);
		if (L_22)
		{
			G_B29_0 = (&V_1);
...
IL_00dc:
	{
		...
		UserDefinedSettings_tE823040D57E8C8C9D8A028F206230E1C7BAC8EE3 L_23 = V_1;
		NativeMethods_SetUserDefinedSettings_m8F63140EA513FAC3AA59EF03F9BA7B8D76BAA70F(L_23, NULL);
	}
...
IL_00e8:
	{
		...
		il2cpp_codegen_runtime_class_init_inline(OculusLoader_tA386B9AA0786D042EA272EDF385F96C0AD1A56BB_il2cpp_TypeInfo_var);
		List_1_tC3F021D09EFA4F3516555517B5E0D39308C9C1B4* L_24 = ((OculusLoader_tA386B9AA0786D042EA272EDF385F96C0AD1A56BB_StaticFields*)il2cpp_codegen_static_fields_for(OculusLoader_tA386B9AA0786D042EA272EDF385F96C0AD1A56BB_il2cpp_TypeInfo_var))->___s_DisplaySubsystemDescriptors_5;
		...
		List_1_tE3AE94237CE649B47E1D52E1A3120E772255FF87* L_25 = ((OculusLoader_tA386B9AA0786D042EA272EDF385F96C0AD1A56BB_StaticFields*)il2cpp_codegen_static_fields_for(OculusLoader_tA386B9AA0786D042EA272EDF385F96C0AD1A56BB_il2cpp_TypeInfo_var))->___s_InputSubsystemDescriptors_6;
		...
		XRDisplaySubsystem_t4B00B0BF1894A039ACFA8DDC2C2EB9301118C1F1* L_26;
		L_26 = OculusLoader_get_displaySubsystem_mBF36D42BABD9D5DA3ECE4F2D25862BF35C29D4E3(__this, NULL);
		if (L_26)
		{
			goto IL_0124;
		}
	}
	{
		...
		L_27 = OculusLoader_get_inputSubsystem_m3690AE48575D2196C79757CE5F21C96F1A0963B2(__this, NULL);
		if (L_27)
		{
			goto IL_0124;
		}
...
IL_0151:
	{
		...
		XRDisplaySubsystem_t4B00B0BF1894A039ACFA8DDC2C2EB9301118C1F1* L_30;
		L_30 = OculusLoader_get_displaySubsystem_mBF36D42BABD9D5DA3ECE4F2D25862BF35C29D4E3(__this, NULL);
		if (!L_30)
		{
			goto IL_0163;
		}
	...
	{
		XRInputSubsystem_tFECE6683FCAEBF05BAD05E5D612690095D8BAD34* L_31;
		L_31 = OculusLoader_get_inputSubsystem_m3690AE48575D2196C79757CE5F21C96F1A0963B2(__this, NULL);
		return (bool)((!(((RuntimeObject*)(XRInputSubsystem_tFECE6683FCAEBF05BAD05E5D612690095D8BAD34*)L_31) <= ((RuntimeObject*)(RuntimeObject*)NULL)))? 1 : 0);
	}
